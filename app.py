...
fig.update_layout(title = 'Statium where done maximum match from 2008-2020',
...
body_app = dbc.Container([
    ...
    dbc.Row( html.H5("Select year "),style = {'color':'white','background':'#2C3E50'}),
    ...
    dbc.Row( html.H5("Select Year, Team1 and Team2 "),style = {'color':'white','background':'#2C3E50'}),
...
def xx(option_slctd, slct_ye1, slct_ye3, slct_ye4):
    ...
    fig4.update_layout(xaxis_title = 'Players Name', yaxis_title = 'Total Runs')
